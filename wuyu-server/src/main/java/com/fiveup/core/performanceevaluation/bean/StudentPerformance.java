...
public class StudentPerformance {
    ...
    public StudentPerformance(Integer id, String name, Integer virtue, Integer intelligence, Integer sports, Integer art, Integer labor, String remark, Integer tid, Integer sid, BigDecimal totalScore) {
        this.id = id;
        this.name = name;
        this.virtue = virtue;
